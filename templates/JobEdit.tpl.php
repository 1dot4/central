            ...
            <form class="form-inline" action="../job.edit.do/<?php echo $jobId ?>" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="bootstrap-tagsinput">
                        <input name="skills" id="text2" type="text" data-role="tagsinput" value="<?php echo $skills ?>">
                    </div>
                </div>
                <br>
                <div class="form-group">
                    <input name="positions" class="form-control" id="text1" type="text" placeholder="Number of vacancies" value="<?php echo $positions ?>">
                </div>
                <br><br>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input id="temporary" type="radio" name="type" value="temporary" <?php if($type == 'temporary') { echo "checked"; }?> >&nbspTemporary&nbsp&nbsp
                    <input id="permanent" type="radio" name="type" value="permanent" <?php if($type == 'permanent') { echo "checked"; }?>>&nbspPermanent
                </div>
                <br><br>
                <div class="form-group">
                    <label>Start date: </label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                    <input name="start" id="start-date" class="form-control" type="date" value="<?php echo $startDate ?>">
                </div>
                <!--     <br><br> -->
                ...
                <script type="text/javascript">   document.getElementById('durationInput').innerHTML = "<br><div class='form-group'><input name='duration' class='form-control' type='text' placeholder='Duration of job(in days)' value='<?php echo $duration ?>'></div>";
                    document.getElementById('postjob').innerHTML = "<div class='form-group'><br><input id='postjob' type='submit' class='btn btn-primary' value='Save Job'></div>";
                </script>
            </form>
        </div>
    </div>
...
<script type="text/javascript">
    function myFunction()
    {document.getElementById('durationInput').innerHTML = "<br><div class='form-group'><input name='duration' class='form-control' type='text' placeholder='Duration of job(in days)' value='<?php echo $duration ?>'></div>";
        document.getElementById('postjob').innerHTML = "<div class='form-group'><br><input id='postjob' type='submit' class='btn btn-primary' value='Save Job'></div>";
    }
</script>
